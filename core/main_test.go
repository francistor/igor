...
-- Radius Clients
INSERT INTO accessNodes (AccessNodeId, Parameters) values ("127.0.0.1", '{"name": "RepublicaHW01", "originIP": "127.0.0.1", "secret": "mysecret", "clientClass": "Huawei", "attributes": [{"Redback-Client_DNS_Pri": "1.2.3.4"}, {"Session-Timeout": 3600}]}');
INSERT INTO accessNodes (AccessNodeId, Parameters) values ("127.0.0.2", '{"name": "RepublicaHW02", "originIP": "127.0.0.2", "secret": "mysecret", "clientClass": "Huawei", "attributes": [{"Redback-Client_DNS_Pri": "1.2.3.4"}, {"Session-Timeout": 7200}]}');
